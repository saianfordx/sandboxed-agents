...
export default function ActivityLog({ entries, isOpen, onToggle, onClear }: ActivityLogProps) {
      ...
      <div className="p-4 border-b border-gray-200 bg-gray-50 flex-shrink-0">
        <div className="flex items-center justify-between">
          ...
          {onClear && entries.length > 0 && (
            <button
              onClick={() => {
                if (confirm('🗑️ Spring Cleaning Time!\n\nTime to tidy up this activity log! This will permanently delete all those behind-the-scenes details I\'ve been showing you. Don\'t worry though - I\'ll keep generating new ones as we chat!\n\nReady to clean house?')) {
                  onClear();
                }
              }}
